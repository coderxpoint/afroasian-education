...
import Form_program from "./_components/FormProgram";
      ...
      >
        <div className="relative z-10 max-w-6xl px-4 w-full gap-4 flex py-10 justify-between items-start h-full flex-col lg:flex-row mx-auto">
          <div className="flex flex-col gap-4 w-full lg:w-auto">
            <div className="font-thin lg:pr-40 text-white">
              <Breadcrumb />
            </div>
            <h1 className="text-2xl lg:text-4xl text-white font-bold">
              {programData.title}
            </h1>
            <p className="text-base lg:text-lg text-white/90 lg:max-w-2xl mt-0 lg:mt-2">
          ...
          <Form_program program={program} programData={programData} />
        </div>
      </div>
