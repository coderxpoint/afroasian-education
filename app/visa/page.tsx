...
import AllVisa from "./_components/AllVisa";
import Breadcrumb from "@/components/Breadcrumb";
import AbroadServices from "./_components/AbroadServices";
...
export default function VisaPage() {
  return (
    <div className="flex flex-col gap-20">
      <div
        className="lg:h-[35vh] bg-[url('/visa.jpg')] bg-center bg-cover bg-no-repeat h-[20vh] relative flex flex-col space-x-4 w-full items-center mx-auto justify-center overflow-hidden 
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
          <Breadcrumb title="VISA" className="text-white" />
        </div>
      </div>
      <AllVisa />
      <AbroadServices />
