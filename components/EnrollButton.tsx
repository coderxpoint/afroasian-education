...
export function EnrollButton() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const backendResponse = await fetch("/api/enrollnow", {
        method: "POST",
        headers: {
      ...
      formData.append("subject", "Enroll now Form");
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          size="lg"
          className="flex bg-[#e86034] items-center gap-2 rounded-full shadow-md hover:shadow-lg transition-all duration-200 hover:bg-[#e86034]/90"
        >
          Enroll Now
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6] rounded-lg border border-gray-200 shadow-2xl">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-blue-950 text-center">
            Enroll Now to Study Abroad
          </DialogTitle>
          <DialogDescription className="text-center text-gray-600">
            Fill out the form below to enroll. We&apos;ll get back to you
            shortly.
          </DialogDescription>
        </DialogHeader>
        <form
          onSubmit={form.handleSubmit(onSubmit)}
          className="gap-4 pt-4 px-4"
        >
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent className="rounded-lg border-gray-300">
                <SelectItem value="International Medical University">
          ...
          <div className="space-y-2">
            <Label htmlFor="program_name" className="text-gray-700 font-medium">
              Programs
            </Label>
            <Select
              onValueChange={(value) => form.setValue("program_name", value)} // Match SQL column name here
            >
              <SelectTrigger className="rounded-lg border-gray-300 focus:border-[#e86034] focus:ring-[#e86034]">
          ...
          <div className="flex justify-center w-full items-center space-x-4 pt-6">
            <Button
              type="submit"
